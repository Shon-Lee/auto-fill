...
console.log(text.includes('a) Tên(2): aaaaaaaa'));
console.log(text.includes('b) Giấy tờ nhân thân/pháp nhân(2): aaaaaaaa'));
console.log(text.includes('c) Địa chỉ(2): aaaaaaaa.'));
console.log(text.includes('d) Điện thoại liên hệ (nếu có):'));
console.log(text.includes('- Thửa đất số aaaa tờ bản đồ số: aaaa, diện tích: aaaa m2.'));
console.log(text.includes('- Địa chỉ thửa đất:'));
