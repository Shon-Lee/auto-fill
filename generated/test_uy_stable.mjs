...
const outputPath = "e:/Tool/generated/uy_quyen_final_test.docx";
...
try {
  ...
  console.log("\nTest data filled:");
  console.log("  Ben A: Nguyen Van A + Tran Thi B");
  console.log("  Ben B: Le Van C");
  console.log("  Map info:", data.to_ban_do_info);
  console.log("  Area:", data.dien_tich_loai_dat);
} catch (error) {
  console.error("❌ Error:", error.message);
  if (error.properties && error.properties.errors) {
    error.properties.errors.forEach(e => console.error("  ", e.message));
  }
}
